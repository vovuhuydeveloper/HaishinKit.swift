...
public final actor MediaMixer {
    ...
    public private(set)  lazy var audioIO = AudioCaptureUnit(session)
    public private(set) lazy var videoIO = VideoCaptureUnit(session)
    public private(set)  lazy var session = CaptureSession()
    @ScreenActor
